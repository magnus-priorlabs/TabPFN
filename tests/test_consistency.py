...
class TestTinyRegressorTwoDevices(ConsistencyTest):
    """Test a regressor with two CPU devices, to simulate multi-device inference."""
    ...
    def get_model(self):
        ...
        regressor.devices_ = (torch.device("cpu"), torch.device("cpu"))
        return regressor
...
class TestMulticlassClassifierTwoDevices(ConsistencyTest):
    """Test a classifier with two CPU devices, to simulate multi-device inference."""
    ...
    def get_model(self):
        ...
        # after the fact.
        classifier.devices_ = (torch.device("cpu"), torch.device("cpu"))
        return classifier
